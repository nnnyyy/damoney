...
public class HelpPageActivity extends AppCompatActivity {
    ...
    private void setViewPagerContents() {
        ...
        bind.ivThumbnail.setImageResource(R.drawable.helppage_2);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_3);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_4);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_5);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_6);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_7);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_8);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_9);
        alist.add(bind.getRoot());
        bind = DataBindingUtil.inflate(inflater, R.layout.help_page_item, mBind.pager, false);
        bind.ivThumbnail.setImageResource(R.drawable.helppage_10);
        alist.add(bind.getRoot());
