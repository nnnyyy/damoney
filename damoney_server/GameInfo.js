...
exports.initBonusItemInfo = function() {
    bonusItemInfo.push(createBonusItemInfo(0, '던킨도너츠', '먼치킨 박스', 1, '/bonus/icon_dunkin.png', [1000,1001,1002,1003,1004,1007,1008,1009,2003]));
    bonusItemInfo.push(createBonusItemInfo(1, '아리따움', '아리따움 3천원권', 1, '/bonus/icon_aritaum.png', [1001,1002,1003,1004,1005,1007,1008,1009,2001]));
    bonusItemInfo.push(createBonusItemInfo(2, 'belif', '수분 크림', 4, '/bonus/test.png', [1000,1001,1002,1003,1004,1007,1008,2001,2003]));
    bonusItemInfo.push(createBonusItemInfo(3, '샤넬', '립스틱 루즈코코', 4, '/bonus/icon_chanel.png', [1002,1003,1004,1005,1006,1007,1008,2002,2004]));
    bonusItemInfo.push(createBonusItemInfo(4, '도미노 피자', '포테이토M + 콜라1.25L', 4, '/bonus/icon_domino.png', [1001,1004,1005,1006,1007,1008,1009,2001,2002]));
    bonusItemInfo.push(createBonusItemInfo(5, '몽블랑', '남성 반지갑', 7, '/bonus/icon_montblanc.png', [1003,1004,1007,1008,1009,2003,2002,2004,3001]));
